...
export default function Header() {
    return (
        <header className="uppercase text-sm pt-8 md:pt-20 w-full max-w-[773px] px-8 md:px-0">
            ...
            <div className="flex w-full justify-between leading-10 flex-col md:flex-row">
                <Menu />
                <address>
